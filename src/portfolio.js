...
const socialMediaLinks = {
  github: "https://github.com/prithwish-rgb",
  linkedin: "https://www.linkedin.com/in/prithwish-karmakar-aa8a9414a/",
  gmail: "prithwishkarmakar22@gmail.com",
...
const aboutSection = {
  ...
  paragraphs: [
    ...
    "When I'm not immersed in development, you'll find me exploring emerging technologies, contributing to the developer community, or working on personal projects that push the boundaries of what's possible."
  ],
  personalInfo: [
    {
      label: "Based in",
    ...
    {
      label: "Interests",
      value: "UI/UX Design, Gen AI, Gaming"
    }
  ],
  profileImage: "profile_portfolio.jpg",
  display: true // Set false to hide this section, defaults to true
};
...
const bigProjects = {
  ...
  projects: [
    {
      image: require("./assets/images/Screenshot (27).png"),
      projectName: "Nomadnest",
      projectDesc: "AI travel agent that helps you to plan your trip",
      footerLink: [
        {
          name: "Visit Website",
          url: "https://nomadnest-prithwish-rgb-prithwish-rgbs-projects.vercel.app"
        }
      ...
      footerLink: [
        {
          ...
          url: "https://www.udemy.com/certificate/UC-f84554c5-2060-4775-85ac-4c1f8fe86bcf/"
        }
      ]
    },
    {
      ...
      // subtitle:
      //   "Developed a Google Assistant Action JavaScript Guru that is available on 2 Billion devices world wide.",
      image: require("./assets/images/Screenshot (36).png"),
      imageAlt: "Ardentcertificate",
      footerLink: [
        {
...
const contactInfo = {
  ...
  number: "+91-6290448770",
  email_address: "prithwishkarmakar22@gmail.com"
};
